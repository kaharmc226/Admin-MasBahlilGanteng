          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
            ...
            <div style={{ display: 'grid', gap: '1rem' }}>
              ...
              <div style={{ display: 'flex', gap: '1rem', marginTop: '2rem' }}>
                 ...
                 <button onClick={handleRegister} className="btn-primary" style={{ flex: 1, padding: '1.2rem', borderRadius: '24px', border: 'none', color: 'white', fontWeight: '800' }}>Kirim Registrasi</button>
              </div>
            </div>
          </motion.div>
        )
