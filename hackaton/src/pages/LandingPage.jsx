    ...
    <div className="premium-mesh" style={{ minHeight: '100vh', color: 'var(--text-main)', overflowX: 'hidden', position: 'relative' }}>
      ...
      <nav style={{ padding: '1.25rem 3rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, zIndex: 1000, background: 'rgba(255, 255, 255, 0.9)', backdropFilter: 'blur(10px)', borderBottom: '1px solid var(--border)' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '3rem' }}>
          ...
          <Link to="/registrasi-vendor" style={{ textDecoration: 'none', color: 'var(--primary)', fontWeight: '800', border: '2px solid var(--primary)', padding: '0.8rem 1.5rem', borderRadius: '24px' }}>Registrasi Vendor</Link>
          <Link to="/login" className="btn-primary" style={{ textDecoration: 'none', padding: '0.9rem 2.5rem', borderRadius: '24px', background: 'linear-gradient(to right, var(--primary), var(--secondary))', boxShadow: '0 10px 25px rgba(16, 185, 129, 0.2)', cursor: 'pointer', position: 'relative', zIndex: 100, color: 'white', border: 'none' }}>Login Portal</Link>
        </div>
      </nav>
        ...
        <div className="grid" style={{ gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
          <motion.div style={{ opacity, scale }}>
            ...
            <motion.h1 
              ...
              style={{ fontSize: '5.5rem', lineHeight: '0.95', fontWeight: '950', letterSpacing: '-4px', marginBottom: '1.5rem', color: 'var(--text-main)' }}
            >
              CERDASKAN <br />
            ...
            >
              ...
              style={{ display: 'flex', gap: '1rem', position: 'relative', zIndex: 100 }}
            >
            ...
            <div style={{ position: 'relative' }}>
              ...
              <motion.div 
                 ...
                 transition={{ delay: 0.8, type: 'spring' }}
                  style={{ position: 'absolute', top: '10%', left: '-4rem', background: 'white', padding: '1.2rem 2rem', borderRadius: '12px', boxShadow: '0 25px 50px rgba(0,0,0,0.15)', display: 'flex', gap: '15px', alignItems: 'center', zIndex: 20 }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          >
            {[
              ...
              <motion.div key={i} variants={item} className="card" style={{ textAlign: 'center', padding: '1.5rem', borderRadius: '16px', border: '1px solid var(--border)' }}>
      ...
      <section id="solusi" style={{ padding: '10rem 3rem', background: 'var(--bg)', position: 'relative', zIndex: 10 }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div className="grid" style={{ gridTemplateColumns: '1fr 1fr', gap: '3rem' }}>
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="card" style={{ padding: '3.5rem', borderRadius: '16px' }}>
              <div style={{ background: 'var(--secondary)', width: '80px', height: '80px', borderRadius: '12px', display: 'grid', placeItems: 'center', boxShadow: '0 10px 25px rgba(34, 197, 94, 0.2)', marginBottom: '1rem' }}><Database color="white" size={36} /></div>
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, delay: 0.1 }} className="card" style={{ padding: '3.5rem', borderRadius: '16px' }}>
              <div style={{ background: 'var(--carrot)', width: '80px', height: '80px', borderRadius: '12px', display: 'grid', placeItems: 'center', boxShadow: '0 10px 25px rgba(249, 115, 22, 0.2)', marginBottom: '1rem' }}><Timer color="white" size={36} /></div>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div className="grid" style={{ gridTemplateColumns: '1.2fr 1fr', gap: '6rem', alignItems: 'center' }}>
            ...
            >
              ...
              <h2 style={{ fontSize: '4rem', fontWeight: '950', color: '#fff', marginBottom: '1.5rem', letterSpacing: '-2px' }}>Keamanan Gizi & Transparansi</h2>
              <p style={{ fontSize: '1.3rem', color: '#a7f3d0', marginBottom: '1.5rem', lineHeight: '1.7', fontWeight: '500' }}>
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              style={{ background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(20px)', padding: '4rem', borderRadius: '24px', border: '1px solid rgba(255, 255, 255, 0.1)', boxShadow: '0 40px 100px rgba(0,0,0,0.2)' }}
            >
               ...
               <p style={{ fontSize: '1.2rem', color: '#a7f3d0', marginBottom: '1.5rem', lineHeight: '1.7', fontWeight: '500' }}>
               ...
               <div style={{ padding: '1.5rem', background: 'rgba(255,255,255,0.95)', borderRadius: '12px', border: '2px dashed var(--primary)' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6rem' }}>
            <div style={{ maxWidth: '400px' }}>
              ...
              <p style={{ color: 'var(--text-muted)', fontSize: '1.2rem', marginBottom: '1.5rem', lineHeight: '1.7', fontWeight: '500' }}>Pengawasan distribusi gizi nasional dengan teknologi mutakhir. Memastikan masa depan bangsa dimulai dari makanan berkualitas.</p>
            ...
            <div style={{ display: 'flex', gap: '10rem' }}>
              <div>
                <h4 style={{ color: 'var(--text-main)', marginBottom: '1.5rem', fontSize: '1.3rem', fontWeight: '900' }}>Platform</h4>
              ...
              <div>
                <h4 style={{ color: 'var(--text-main)', marginBottom: '1.5rem', fontSize: '1.3rem', fontWeight: '900' }}>Dukungan</h4>
                <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '1.4rem', color: 'var(--text-muted)', fontWeight: '700' }}>
